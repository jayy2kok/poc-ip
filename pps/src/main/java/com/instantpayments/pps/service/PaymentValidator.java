...
/**
 * Validates payment request fields:
...
public class PaymentValidator {
    ...
    private static final Set<String> VALID_COUNTRIES = Set.of(
            "USA", "GBR", "DEU", "FRA", "JPN", "CHN", "IND", "BRA", "AUS", "CAN",
            "ITA", "ESP", "MEX", "KOR", "RUS", "NLD", "CHE", "SGP", "HKG", "NZL",
            "SWE", "NOR", "DNK", "FIN", "AUT", "BEL", "IRL", "PRT", "GRC", "POL",
            "CZE", "HUN", "ROU", "BGR", "HRV", "SVK", "SVN", "LTU", "LVA", "EST",
            "ZAF", "NGA", "KEN", "EGY", "MAR", "TUN", "GHA", "TZA", "UGA", "ETH",
            "SAU", "ARE", "QAT", "KWT", "BHR", "OMN", "JOR", "LBN", "ISR", "TUR",
            "ARG", "CHL", "COL", "PER", "VEN", "URY", "ECU", "BOL", "PRY", "GUY",
            "THA", "VNM", "MYS", "IDN", "PHL", "PAK", "BGD", "LKA", "MMR", "KHM",
            "CUB", "IRQ", "IRN", "PRK", "SDN", "SYR",  // Blacklisted countries (but valid codes)
            "TWN", "ISL"
    );
    ...
    private static final Set<String> VALID_CURRENCIES = Set.of(
            ...
            "SEK", "NOK", "DKK", "SGD", "HKD", "NZD", "KRW", "TRY", "ZAR", "MXN",
            "PLN", "CZK", "HUF", "RON", "BGN", "HRK", "RUB", "THB", "MYR", "IDR",
            "PHP", "VND", "SAR", "AED", "QAR", "KWD", "BHD", "OMR", "JOD", "ILS",
            "EGP", "NGN", "KES", "GHS", "TZS", "PKR", "BDT", "LKR", "ARS", "CLP",
            "COP", "PEN"
    );
    ...
    public List<Map<String, String>> validate(PaymentPayload payload) {
        ...
        if (payload.getPayerCountryCode() == null || !VALID_COUNTRIES.contains(payload.getPayerCountryCode())) {
            errors.add(Map.of("field", "payerCountryCode", "message", "Invalid ISO 3166-1 alpha-3 country code"));
        }
        if (payload.getPayeeCountryCode() == null || !VALID_COUNTRIES.contains(payload.getPayeeCountryCode())) {
            errors.add(Map.of("field", "payeeCountryCode", "message", "Invalid ISO 3166-1 alpha-3 country code"));
        }
