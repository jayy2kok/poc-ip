 ...
 * <p>
 * Tests submit a payment through PPS (port 8081), wait for CDC to propagate
 * the change to the Audit Service (port 8084), and then verify the audit
 * trail through the Audit Service API.
 * <p>
 * <b>Prerequisites:</b> All Docker containers must be running
 * ({@code docker-compose up -d}), including Debezium for CDC.
 */
