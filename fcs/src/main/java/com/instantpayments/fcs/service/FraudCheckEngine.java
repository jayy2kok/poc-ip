...
/**
 * Core fraud check engine. Performs case-insensitive blacklist matching against payer/payee names,
 * countries, banks, and payment instructions.
 */
@Service
public class FraudCheckEngine {
  ...
  private boolean matchesAny(String value, List<String> blacklistedValues) {
    ...
    return blacklistedValues.stream().anyMatch(bl -> bl.equalsIgnoreCase(value));
  }
