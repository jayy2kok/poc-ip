...
public class BlacklistProperties {
    ...
    public List<String> getPaymentInstructions() { return paymentInstructions; }
    public void setPaymentInstructions(List<String> paymentInstructions) { this.paymentInstructions = paymentInstructions; }
}
