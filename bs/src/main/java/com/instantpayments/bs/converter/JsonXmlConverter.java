...
/**
 * Converts PaymentPayload JSON objects to XML fraud check request strings
 * and fraud check response XML strings back to JSON notifications.
 */
@Component
public class JsonXmlConverter {
    ...
    public String toFraudCheckXml(PaymentPayload payload) {
        ...
        xml.append("    <transactionId>").append(payload.getTransactionId()).append("</transactionId>\n");
        xml.append("    <payer>\n");
        ...
        xml.append("        <countryCode>").append(payload.getPayerCountryCode()).append("</countryCode>\n");
        ...
        xml.append("        <countryCode>").append(payload.getPayeeCountryCode()).append("</countryCode>\n");
        xml.append("        <account>").append(payload.getPayeeAccount()).append("</account>\n");
        xml.append("    </payee>\n");
        if (payload.getPaymentInstruction() != null) {
            xml.append("    <paymentInstruction>").append(escapeXml(payload.getPaymentInstruction())).append("</paymentInstruction>\n");
        }
        xml.append("    <executionDate>").append(payload.getExecutionDate()).append("</executionDate>\n");
